package br.com.distrischool.communication.config;
...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_NAME = "communication.events.queue";
    public static final String ROUTING_KEY = "grade.*";
    
    // Dead Letter Queue configuration
    public static final String DLQ_EXCHANGE_NAME = "distrischool.dlx.exchange";
    public static final String DLQ_QUEUE_NAME = "communication.events.dlq";
    public static final String DLQ_ROUTING_KEY = "communication.dlq";
