...
public class UserController {
    ...
    //-------------------------------------------------------------
    // GET /users/available-for-role/{role}
    //-------------------------------------------------------------
    @GetMapping("/available-for-role/{role}")
    public ResponseEntity<List<UserResponse>> listAvailableByRole(@PathVariable Role role) {
        return ResponseEntity.ok(service.listAvailableByRole(role));
    }
